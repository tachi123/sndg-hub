...
<html>
	...
	<body>
		<a href="#create-unidad" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-unidad" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:unidadInstance, action:'save']" >
				<fieldset class="form">
